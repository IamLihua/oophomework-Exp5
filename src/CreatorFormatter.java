 ...
 * <p>2.XML</p>
 * <p>3.HTML</p>
 * <b>此处的{@code Creator}其实就是{@link Student}类的一种</b>
 */
public class CreatorFormatter implements UserFormatter<Student> {
	/**
	...
	public String formatXML(Student student) {
		String result="	<Creator id=\""+student.getId()+
				" name=\""+student.getName()+
				" phoneNo=\""+student.getPhoneNo()+
				" email=\""+student.getEmail()+
				" studentNo=\""+student.getStudentNo()+
	...
	public String formatHTML(Student student) {
		String result="		creator["+student.getId()+" "+student.getName()+" "+student.getPhoneNo()+" "+student.getEmail()
